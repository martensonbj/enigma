...
require_relative '../lib/message_to_encrypt'
require 'pry'

class MessageToEncryptTest < Minitest::Test

  attr_reader :offset

  def test_the_character_array_is_complete
    e = MessageToEncrypt.new(message, offset)
  ...
  def test_a_string_is_produced
    e = MessageToEncrypt.new('huzzah', offset)
